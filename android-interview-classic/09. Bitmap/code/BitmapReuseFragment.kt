    ...
    override fun init(view: View, savedInstanceState: Bundle?) {
        ...
        addButton("生成500个相同的Bitmap") {
            for (i in 0 until 500) {
                BitmapFactory.decodeResource(resources, R.mipmap.lvmaochong_xh)
            }
        }
        ...
        addButton("生成500个相同的Bitmap(复用内存)") {
            ...
            var bitmapFirst = BitmapFactory.decodeResource(resources, R.mipmap.lvmaochong_xh, options)
            ...
            for (i in 0 until 500) {
                ...
                bitmapFirst = BitmapFactory.decodeResource(resources, R.mipmap.lvmaochong_xh, options)
            }
        }
